...
data ShTy = SHT_NULL | SHT_PROGBITS | SHT_SYMTAB | SHT_STRTAB | SHT_RELA |
           ...
           SHT_HEX_ORDERED | SHT_X86_64_UNWIND | SHT_MIPS_REGINFO |
           SHT_MIPS_OPTIONS | SHT_MIPS_DWARF | SHT_MIPS_ABIFLAGS |
           SHT_MSP430_ATTRIBUTES | SHT_RISCV_ATTRIBUTES | SHT_CSKY_ATTRIBUTES |
...
getShTy a
  ...
  | a==1879048192 = Right SHT_HEX_ORDERED
  ...
  | a==1879048193 = Right SHT_CSKY_ATTRIBUTES
